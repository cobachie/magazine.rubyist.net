...
普段で普通に作業していることでも、脳内ではこんなに色々考えているだ……と感じられる章になっているかと思います。

#### 第 4 章 画面のデザインを変えてみよう

Bootstrapを使って、画面のデザインをInstagramっぽく変えていきます。( 34ページ )

最初の節で、一度Railsアプリケーションから離れ、HTMLの要素とCSSについて数行のプログラムを通して説明し、
...
プログラミングは難しいと敬遠しているひとりでも多くの方に、Rails Girlsに参加して欲しいと思っていますが、その情報を届けるのが難しいと感じています。Rails Girlsの内容がまとまった本が書店に並んでいたら、そういった方に、少しでもプログラミングの楽しさを感じられるのではないか……と思い、今回執筆しました。思った以上に執筆作業は大変でしたが、(emorima)
...
株式会社ケーシーエスキャロット 執行役員。Asakusa.rbメンバー。酒と Ruby と時々(福山)雅治。
